...
Generated by Elite AI Tools Metadata Analyzer`;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-40">
        <div className="container mx-auto px-2 md:px-4 py-3 md:py-4">
          <div className="flex items-center space-x-2 md:space-x-3">
            <div className="p-1.5 md:p-2 rounded-lg bg-blue-100 dark:bg-blue-900">
              <FileSearch className="h-4 w-4 md:h-6 md:w-6 text-blue-600 dark:text-blue-400" />
            </div>
            <div>
      ...
      {/* Main Content */}
      <div className="container mx-auto px-2 md:px-4 py-4 md:py-6 max-w-6xl"></div>
        <div className="grid gap-4 md:gap-6 lg:grid-cols-2">
          {/* Left Column - Upload */}
          <div className="space-y-4 md:space-y-6">
            <div className="border rounded-lg p-3 md:p-4">
              <h2 className="text-base md:text-lg font-semibold flex items-center space-x-2 mb-2">
                <FileSearch className="h-4 w-4 md:h-5 md:w-5 text-blue-500" />
            ...
            {/* Error Display */}
            {error && (
              <div className="border border-red-200 dark:border-red-800 rounded-lg p-3 md:p-4">
                <h3 className="text-red-600 dark:text-red-400 text-base md:text-lg font-semibold mb-2">
                  Analysis Error
                </h3>
          ...
          <div className="space-y-4 md:space-y-6">
            {analysisResult ? (
              ...
              <div className="border-dashed border-2 rounded-lg p-6 md:p-12 text-center">
                <FileSearch className="h-12 w-12 md:h-16 md:w-16 text-muted-foreground/50 mb-3 md:mb-4 mx-auto" />
        ...
        {/* Info Section */}
        <div className="mt-6 md:mt-8 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 md:p-6">
          ...
          <div className="grid md:grid-cols-3 gap-3 md:gap-4 text-xs md:text-sm">
            <div>
              <h4 className="font-medium text-blue-800 dark:text-blue-200 mb-1 md:mb-2">🤖 AI Generation</h4>
            ...
            <div>
              <h4 className="font-medium text-blue-800 dark:text-blue-200 mb-1 md:mb-2">📷 Technical Details</h4>
              <ul className="text-blue-700 dark:text-blue-300 space-y-0.5">
            ...
            <div>
              <h4 className="font-medium text-blue-800 dark:text-blue-200 mb-1 md:mb-2">🎯 Camera Data</h4>
              <ul className="text-blue-700 dark:text-blue-300 space-y-0.5">
