...
export function QuickActions({ 
  ...
  return (
    <Card data-testid="card-quick-actions">
      ...
      <CardContent className="grid grid-cols-4 gap-1 md:flex md:flex-col md:space-y-3 pt-1 md:pt-3">
        <Button
          variant="ghost"
          className="flex flex-col items-center justify-center p-1 h-auto md:flex-row md:justify-start md:w-full md:p-3"
          onClick={onCreatePrompt}
          data-testid="button-create-prompt"
        >
          <div className="w-8 h-8 md:w-8 md:h-8 bg-primary/10 rounded-md flex items-center justify-center mb-1 md:mb-0 md:mr-3">
        ...
        >
          <div className="w-8 h-8 md:w-8 md:h-8 bg-green-500/10 rounded-md flex items-center justify-center mb-1 md:mb-0 md:mr-3">
        ...
        >
          <div className="w-8 h-8 md:w-8 md:h-8 bg-blue-500/10 rounded-md flex items-center justify-center mb-1 md:mb-0 md:mr-3">
        ...
        >
          <div className="w-8 h-8 md:w-8 md:h-8 bg-purple-500/10 rounded-md flex items-center justify-center mb-1 md:mb-0 md:mr-3">
