...
export function MobilePageNav() {
  ...
  return (
    <div className="block lg:hidden fixed left-0 right-0 z-50 bg-background/95 dark:bg-background/95 backdrop-blur-sm border-t border-border p-3 pb-8" style={{ bottom: '20px' }}>
