...
export function MobilePageNav() {
  ...
  return (
    <div className="block lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/95 dark:bg-background/95 backdrop-blur-sm border-t border-border p-3" style={{ paddingBottom: "calc(32px + env(safe-area-inset-bottom, 0px))" }}>
