...
export default function Codex() {
  ...
  const saveAssembledStringMutation = useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      queryClient.invalidateQueries({ queryKey: ["/api/codex/assembled-strings", "preset"] });
      queryClient.invalidateQueries({ queryKey: ["/api/codex/assembled-strings", "wildcard"] });
      setSaveDialogOpen(false);
      setSaveName("");
      // Clear the assembled string after successful save
      setAssembledString([]);
      setSelectedTerms([]);
    },
  });
    ...
    <>
      ...
      <div className="mb-4 sm:mb-6">
        ...
        <p className="text-sm sm:text-base text-muted-foreground">
          Browse and Assemble our extensive database of Keyword Terms for prompt inspiration as well as creating wildcard sets for generating with Stable Diffusion
        </p>
      </div>
          ...
          <div className="lg:col-span-3 order-2 lg:order-2">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="browse" className="space-y-3">
                ...
                {/* Terms count display without pagination */}
                {sortedTerms.length > 0 && (
                  <div className="flex items-center justify-center px-2 py-2 border-t mt-2">
                    <div className="text-xs sm:text-sm text-muted-foreground">
                      Showing all {sortedTerms.length} terms
                    </div>
                  </div>
                )}
              </TabsContent>
                              ...
                              <div className="flex gap-1">
                                <Button
                                  ...
                                  onClick={() => {
                                    ...
                                    toast({
                                      title: "Recalled!",
                                      description: `Loaded "${preset.name}" into assembler`,
                                    });
                                  }}
                                ...
                                <Button
                                  ...
                                  onClick={() => {
                                    ...
                                    toast({
                                      ...
                                      description: "Preset copied in shareable format",
                                    });
                                  }}
                              ...
                              <div className="flex gap-1">
                                  <Button
                                    ...
                                    onClick={() => {
                                      ...
                                      toast({
                                        title: "Recalled!",
                                        description: `Loaded "${wildcard.name}" into assembler`,
                                      });
                                    }}
                                    title="Recall this wildcard"
                                    data-testid={`button-recall-wildcard-${wildcard.id}`}
                                  >
                                    <Upload className="w-3 h-3" />
                                  </Button>
                                  <Button
                                  ...
                                  <Button
                                    ...
                                    onClick={() => {
                                      ...
                                      toast({
                                        title: "Ready to share!",
                                        description: "Wildcard copied in shareable format",
                                      });
                                    }}
                                    title="Share this wildcard"
                                    data-testid={`button-share-wildcard-${wildcard.id}`}
                                  >
                                    <Share2 className="w-3 h-3" />
                                  </Button>
                                  <Button
