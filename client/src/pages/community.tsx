...
export default function Community() {
  ...
  return (
    <div className="container mx-auto px-2 py-2 sm:px-3 sm:py-3 md:px-6 md:py-8 pb-24 lg:pb-8">
      ...
      {/* My Communities Section - Only show if user has private communities but CommunityContextTabs won't show */}
      {/* CommunityContextTabs handles the display when user has private communities, so this is now redundant */}
      {/* Commenting out to avoid redundancy */}
      {false && (
        <Card className="mb-4">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-lg">
